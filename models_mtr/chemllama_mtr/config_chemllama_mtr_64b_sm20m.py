...
# Global parameters
MAX_SEQ_LENGTH = 512
tokenizer = fn_load_tokenizer_chemllama(
    max_seq_length=MAX_SEQ_LENGTH,
    dir_tokenizer='/scratch/ylee/ChemLlama/models_mtr/tokenizer.json',
)
...
NUM_DATASET_SIZE = 20 #######  여기 제발
NUM_HPC_PROCESS = 10 # process for csv reading ############ 여기 제발
...
NAME_MODEL = "ChemLlama_Small_20m" ########## # 여기 제발
