...
from models_mtr.chembart_mtr import config_chembart_mtr_64b_med10m as config
...
for ver_ft in range(0, 5):
    ...
    name_model_mtr = "ChemBart_Small_10m"
    model_class = "bart"
    model_version = 0
    tokenizer = utils.fn_load_tokenizer_chembart(
