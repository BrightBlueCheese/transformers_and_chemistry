...
from models_mtr.chemllama_mtr import config_chemllama_mtr_64b_sm10m as config
...
for ver_ft in range(0, 5):
    ...
    name_model_mtr = "ChemLlama_Medium_10m"
    model_class = "llama"
    model_version = 0
    tokenizer = utils.fn_load_tokenizer_chemllama(
